...
function CardPostagensFeed({ post }: CardPostagensProps) {
    ...
    return (
        <div className='flex justify-center'>
            <div className='dark:border-slate-300 border-slate-900 border flex-col w-[75%] dark:bg-black dark:text-white'>
                ...
                <div>
                    ...
                    <div className='p-4'>
                        ...
                        <p className='text-blue-900 font-bold ml-6'>Tema: {post.tema?.nome}</p>
                        <hr className='w-full' />
